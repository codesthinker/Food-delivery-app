...
const SingleRecipie = () => {
    ...
    return (
        <div className='mt-5 px-4 md:px-8 lg:px-20 py-10'>
            ...
            <h1 className='text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-8'>Recipe Detail</h1>
            ...
            <div className='flex flex-col lg:w-2/3 mx-auto space-y-4'>
                ...
                <p className='text-lg md:text-xl lg:text-2xl'>
                    <span className='font-semibold'>Prep Time (Minutes):</span> {recipe.prepTimeMinutes}
                </p>
                <p className='text-lg md:text-xl lg:text-2xl'>
                    <span className='font-semibold'>Cook Time (Minutes):</span> {recipe.cookTimeMinutes}
                </p>
                <p className='text-lg md:text-xl lg:text-2xl'>
                    <span className='font-semibold'>Rating:</span> {recipe.rating}
                </p>
                <p className='text-lg md:text-xl lg:text-2xl'>
                    <span className='font-semibold'>Review Count:</span> {recipe.reviewCount}
                </p>
                <p className='text-lg md:text-xl lg:text-2xl'>
